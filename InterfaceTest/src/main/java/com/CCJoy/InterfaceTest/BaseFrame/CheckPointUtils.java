...
public class CheckPointUtils {
     ...
     * @param actual   实际结果
     * @param expected 预期结果
     * @param comment  备注信息，可写可不写
     * @TODO：检查 int 型数字
     * @author 作者 邱卫武:
     * @date 创建时间：2015年9月5日 下午7:58:25
     */
